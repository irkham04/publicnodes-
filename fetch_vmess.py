...
import re, base64, json, pathlib, asyncio

# Secrets diisi otomatis oleh GitHub Action (API_ID, API_HASH, PHONE)
...
async def main():
    ...
    # ambil 30 pesan terakhir dari channel publik @foolvpn
